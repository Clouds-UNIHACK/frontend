      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            ...
            >
              Transform your wardrobe instantly with our AI-powered swapping
              technology. Experience the future of fashion where you can
              visualize new styles before making a purchase.
            </Typography>
